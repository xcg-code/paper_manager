						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">检查导入数据</h3>
									</div>
									<div class="description">查看，导入</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border">
									<div class="box-title">
										<h4><i class="fa fa-user"></i><span class="hidden-inline-mobile">待导入数据审核</span></h4>
									</div>
									<div class="box-body">
										<div class="tabbable header-tabs">
											<ul class="nav nav-tabs">
												<li class="active"><a href="#box_tab1" data-toggle="tab"><i class="fa fa-calendar-o"></i> <span class="hidden-inline-mobile"></span></a></li>
											</ul>
														...
														<div class="col-md-12">
															<div class="box-body">
																<div class="box border blue">
																	<div class="box-title">
																		<h4><i class="fa fa-table"></i>已读取科研成果信息</h4>
																	</div>
																	<div class="box-body">
