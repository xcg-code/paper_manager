						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border">
									<div class="box-title">
										<h4><i class="fa fa-user"></i><span class="hidden-inline-mobile">举办或参加学术会议</span></h4>
									</div>
									<div class="box-body">
										<div class="tabbable header-tabs">
											...
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<form class="form-horizontal" action="/PaperManager/index.php/Home/Achievement/conference_involved_edit_db/achi_id/<?php echo ($ConInfo["id"]); ?>" method="post">
														<div class="row">
															<div class="col-md-12">
																<div class="box-body">
																	<div class="form-group">
																		...
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="type" value="举办国际学术会议" <?php if($ConInfo["type"] == 举办国际学术会议): ?>checked<?php endif; ?>> 举办国际学术会议 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="type" value="举办国内学术会议" <?php if($ConInfo["type"] == 举办国内学术会议): ?>checked<?php endif; ?>> 举办国内学术会议 </label>
																			<label class="radio-inline"> <input type="radio" class="uniform" name="type" value="参加国际学术会议" <?php if($ConInfo["type"] == 参加国际学术会议): ?>checked<?php endif; ?>> 参加国际学术会议 </label>
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">会议名称(中文)</label> 
																		<div class="col-md-8"><input type="text" name="title_zh" class="form-control" value="<?php echo ($ConInfo["title_zh"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">会议名称(英文)</label> 
																		<div class="col-md-8"><input type="text" name="title_en" class="form-control" value="<?php echo ($ConInfo["title_en"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">会议地点</label> 
																		<div class="col-md-8"><input type="text" name="address" class="form-control" value="<?php echo ($ConInfo["address"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">会议开始日期</label> 
																		<div class="col-md-2"><input type="date" name="start_date" class="form-control" value="<?php echo ($ConInfo["start_date"]); ?>"></div>
																		<label class="col-md-2 control-label">会议结束日期</label> 
																		<div class="col-md-2"><input type="date" name="end_date" class="form-control" value="<?php echo ($ConInfo["end_date"]); ?>"></div>
																		
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">主办单位</label> 
																		<div class="col-md-8"><input type="text" name="institute" class="form-control" value="<?php echo ($ConInfo["institute"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">会议负责人</label> 
																		<div class="col-md-8"><input type="text" name="holder" class="form-control" value="<?php echo ($ConInfo["holder"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">参会人数</label> 
																		<div class="col-md-3"><input type="text" name="people_num" class="form-control" value="<?php echo ($ConInfo["people_num"]); ?>"></div>
																		
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">备注</label> 
																		<div class="col-md-8"><textarea name="content" class="form-control"><?php echo ($ConInfo["content"]); ?></textarea></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">全文链接</label> 
																		<div class="col-md-8"><input type="text" name="paper_link" class="form-control" value="<?php echo ($ConInfo["paper_link"]); ?>"></div>
																	</div>
																</div>
															</div>
														</div>
