															...
															<div class="col-md-12">
																<div class="box-body">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="country" value="申请"> 申请 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="country" value="授权"> 授权 </label> 
																		</div>
																	</div>
																	<div class="form-group">
