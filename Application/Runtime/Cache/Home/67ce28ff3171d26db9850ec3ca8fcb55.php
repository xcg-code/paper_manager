					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left"><?php echo ($MonographInfo["title_zh"]); ?></h3>
									</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i><?php echo ($MonographInfo["title_zh"]); ?></h4>
														...
														<table class="table table-striped">
															<tbody>
																<tr>
																	...
																	<td><?php echo ($MonographInfo["achievement_type"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">专著题目(中文)</td>
																	<td><?php echo ($MonographInfo["title_zh"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">专著题目(英文)</td>
																	<td><?php echo ($MonographInfo["title_en"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">书名</td>
																	<td><?php echo ($MonographInfo["book_name"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">丛书名</td>
																	<td><?php echo ($MonographInfo["books_name"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">语言</td>
																	<td><?php echo ($MonographInfo["language"]); ?></td>
																</tr>
																<tr>
																<td style="width: 15%;text-align:center">状态</td>
																	<td><?php echo ($MonographInfo["status"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">ISBN号</td>
																	<td><?php echo ($MonographInfo["isbn"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">编辑</td>
																	<td><?php echo ($MonographInfo["editor"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">国家或地区</td>
																	<td><?php echo ($MonographInfo["country"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">城市</td>
																	<td><?php echo ($MonographInfo["city"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">起止页码</td>
																	<td><?php echo ($MonographInfo["start_page"]); ?> ~ <?php echo ($MonographInfo["end_page"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">总字数</td>
																	<td><?php echo ($MonographInfo["words_num"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">出版社</td>
																	<td><?php echo ($MonographInfo["publisher"]); ?></td>
																</tr>
																
																<tr>
																	<td style="width: 15%;text-align:center">出版时间</td>
																	<td><?php echo ($MonographInfo["publish_date"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">与项目的关系</td>
																	<td><?php echo ($MonographInfo["relationship"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">备注</td>
																	<td><?php echo ($MonographInfo["content"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">全文链接</td>
																	<td><?php echo ($MonographInfo["paper_link"]); ?></td>
																</tr>
															</tbody>
														</table>
													</div>
