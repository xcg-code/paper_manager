...
<body>
	...
	<section id="page">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border">
									<div class="box-title">
										<h4><i class="fa fa-user"></i><span class="hidden-inline-mobile">标准</span></h4>
									</div>
									<div class="box-body">
										<div class="tabbable header-tabs">
											...
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<form class="form-horizontal" action="/PaperManager/index.php/Home/Achievement/standard_edit_db/achi_id/<?php echo ($StandardInfo["id"]); ?>" method="post">
														<div class="row">
															<div class="col-md-12">
																<div class="box-body">
																	<div class="form-group">
																		...
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="country" value="国际标准" id="international" <?php if($StandardInfo["country"] == 国际标准): ?>checked<?php endif; ?>> 国际标准 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="country" value="中国标准" id="chinese" <?php if($StandardInfo["country"] == 中国标准): ?>checked<?php endif; ?>> 中国标准 </label>
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">标准名称(中文)</label> 
																		<div class="col-md-8"><input type="text" name="title_zh" class="form-control" value="<?php echo ($StandardInfo["title_zh"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">标准名称(英文)</label> 
																		<div class="col-md-8"><input type="text" name="title_en" class="form-control" value="<?php echo ($StandardInfo["title_en"]); ?>"></div>
																	</div>
																	<div id="type">
																		<?php if(($StandardInfo["country"]) == "中国标准"): ?><div class="form-group">
																				<label class="col-md-2 control-label">标准类型</label> 
																				<div class="col-md-8"><select class="form-control" name="standard_type">
																					<option></option>
																					<option <?php if($StandardInfo["standard_type"] == '国家标准(强制)'): ?>selected="selected"<?php endif; ?>>国家标准(强制)</option>
																					<option <?php if($StandardInfo["standard_type"] == '国家标准(推荐)'): ?>selected="selected"<?php endif; ?>>国家标准(推荐)</option>
																					<option <?php if($StandardInfo["standard_type"] == '行业标准(强制)'): ?>selected="selected"<?php endif; ?>>行业标准(强制)</option>
																					<option <?php if($StandardInfo["standard_type"] == '行业标准(推荐)'): ?>selected="selected"<?php endif; ?>>行业标准(推荐)</option>
																					<option <?php if($StandardInfo["standard_type"] == '地方标准'): ?>selected="selected"<?php endif; ?>>地方标准</option>
																					<option <?php if($StandardInfo["standard_type"] == '企业标准'): ?>selected="selected"<?php endif; ?>>企业标准</option>
																				</select></div>
																			</div><?php endif; ?>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">标准号</label> 
																		<div class="col-md-8"><input type="text" name="standard_num" class="form-control" value="<?php echo ($StandardInfo["standard_num"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label" id="institute">标准公布机构</label> 
																		<div class="col-md-8"><input type="text" name="institute" class="form-control" value="<?php echo ($StandardInfo["institute"]); ?>"></div>
																	</div>									
																	<div class="form-group">
																		<label class="col-md-2 control-label">发布时间</label> 
																		<div class="col-md-3"><input type="date" name="publish_date" class="form-control" value="<?php echo ($StandardInfo["publish_date"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">备注</label> 
																		<div class="col-md-8"><textarea name="content" class="form-control"><?php echo ($StandardInfo["content"]); ?></textarea></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">全文链接</label> 
																		<div class="col-md-8"><input type="text" name="paper_link" class="form-control" value="<?php echo ($StandardInfo["paper_link"]); ?>"></div>
																	</div>
																</div>
															</div>
														</div>
		...
		<div id="standard_type" hidden="true">
			<div class="form-group">
				<label class="col-md-2 control-label">标准类型</label> 
				<div class="col-md-8"><select class="form-control" name="standard_type">
					<option></option>
	...
	<script>
		...
		jQuery(document).ready(function() {		
			...
			$("#chinese").click(function(){
				x=document.getElementById("type");  // 找到元素
				var i=$("#standard_type").html().replace('true','false');
				x.innerHTML=i;    // 改变内容
				a=document.getElementById("institute");  // 找到元素
				a.innerHTML="标准归口单位";
			});
