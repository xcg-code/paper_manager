					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>请先选择科研成果类型</h4>
									...
									<div class="box-body">
										<div class="row">
											...
											<div class="col-md-3">
												<a class="btn btn-primary btn-icon input-block-level" href="/PaperManager/index.php/Home/Achievement/patent_add">
													<i class="fa fa-book fa-2x"></i>
													<div>专利</div>
												</a>
											</div>
											<div class="col-md-3">
												<a class="btn btn-primary btn-icon input-block-level" href="/PaperManager/index.php/Home/Achievement/conference_report_add">
													<i class="fa fa-book fa-2x"></i>
													<div>会议报告</div>
												</a>
											</div>
											<div class="col-md-3">
												<a class="btn btn-primary btn-icon input-block-level" href="/PaperManager/index.php/Home/Achievement/standard_add">
													<i class="fa fa-book fa-2x"></i>
													<div>标准</div>
												</a>
											</div>
											<div class="col-md-3">
												<a class="btn btn-primary btn-icon input-block-level" href="/PaperManager/index.php/Home/Achievement/software_add">
													<i class="fa fa-book fa-2x"></i>
													<div>软件著作权</div>
												</a>
											</div>
											<div class="col-md-3">
												<a class="btn btn-primary btn-icon input-block-level" href="/PaperManager/index.php/Home/Achievement/reward_add">
													<i class="fa fa-book fa-2x"></i>
													<div>科研奖励</div>
												</a>
											</div>
											...
											<div class="col-md-3">
												<a class="btn btn-primary btn-icon input-block-level" href="/PaperManager/index.php/Home/Achievement/conference_involved_add">
													<i class="fa fa-book fa-2x"></i>
													<div>举办或参加学术会议</div>
												</a>
											</div>
