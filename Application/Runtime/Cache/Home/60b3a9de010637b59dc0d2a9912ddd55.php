						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border">
									<div class="box-title">
										<h4><i class="fa fa-user"></i><span class="hidden-inline-mobile">软件著作权</span></h4>
									</div>
									<div class="box-body">
										<div class="tabbable header-tabs">
											...
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<form class="form-horizontal" action="/PaperManager/index.php/Home/Achievement/software_edit_db/achi_id/<?php echo ($SoftwareInfo["id"]); ?>" method="post">
														<div class="row">
															<div class="col-md-12">
																<div class="box-body">
																	<div class="form-group">
																		<label class="col-md-2 control-label">软件名称(中文)</label> 
																		<div class="col-md-8"><input type="text" name="title_zh" class="form-control" value="<?php echo ($SoftwareInfo["title_zh"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">软件名称(英文)</label> 
																		<div class="col-md-8"><input type="text" name="title_en" class="form-control" value="<?php echo ($SoftwareInfo["title_en"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">登记号</label> 
																		<div class="col-md-8"><input type="text" name="reg_num" class="form-control" value="<?php echo ($SoftwareInfo["reg_num"]); ?>"></div>
																	</div>
																	<div class="form-group">
																	<label class="col-md-2 control-label">权利获得方式</label> 
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="get_type" value="原始取得" <?php if($SoftwareInfo["get_type"] == 原始取得): ?>checked<?php endif; ?>> 原始取得 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="get_type" value="继受取得" <?php if($SoftwareInfo["get_type"] == 继受取得): ?>checked<?php endif; ?>> 继受取得 </label>
																		</div>
																	</div>
																	<div class="form-group">
																	<label class="col-md-2 control-label">权利范围</label> 
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="right_type" value="全部权利" <?php if($SoftwareInfo["right_type"] == 全部权利): ?>checked<?php endif; ?>> 全部权利 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="right_type" value="部分权利" <?php if($SoftwareInfo["right_type"] == 部分权利): ?>checked<?php endif; ?>> 部分权利 </label>
																		</div>
																	</div>
																	
																	<div class="form-group">
																		<label class="col-md-2 control-label">请注明</label> 
																		<div class="col-md-8"><input type="text" name="specific" class="form-control" value="<?php echo ($SoftwareInfo["specific"]); ?>"></div>
																	</div>

																	<div class="form-group">
																		<label class="col-md-2 control-label">开发完成时间</label> 
																		<div class="col-md-2"><input type="date" name="over_date" class="form-control" value="<?php echo ($SoftwareInfo["over_date"]); ?>"></div>
																		
																	</div>									
																	<div class="form-group">
																		<label class="col-md-2 control-label">备注</label> 
																		<div class="col-md-8"><textarea name="content" class="form-control"><?php echo ($SoftwareInfo["content"]); ?></textarea></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">全文链接</label> 
																		<div class="col-md-8"><input type="text" name="paper_link" class="form-control" value="<?php echo ($SoftwareInfo["paper_link"]); ?>"></div>
																	</div>
																</div>
															</div>
														</div>
