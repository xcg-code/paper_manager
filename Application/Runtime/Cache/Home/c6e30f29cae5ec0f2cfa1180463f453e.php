										...
										<div class="tabbable header-tabs">
											...
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<form class="form-horizontal" action="/PaperManager/index.php/Home/Achievement/standard_add_db" method="post">
														<div class="row">
															<div class="col-md-12">
																<div class="box-body">
		...
		<div id="standard_type" hidden="true">
			<div class="form-group">
				...
				<div class="col-md-8"><select class="form-control" name="standard_type">
					<option></option>
					<option>国家标准(强制)</option>
					<option>国家标准(推荐)</option>
					<option>行业标准(强制)</option>
					<option>行业标准(推荐)</option>
					<option>地方标准</option>
					<option>企业标准</option>
				</select></div>
			</div>
