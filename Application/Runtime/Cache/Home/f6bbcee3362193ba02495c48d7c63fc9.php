									...
									<div class="box-body">
										<div class="row">
											<div class="col-md-3">
												...
												<a href="/PaperManager/index.php/Home/Achievement/project_add/achi_id/<?php echo ($JournalInfo["id"]); ?>" class="list-group-item"><i class="fa fa-user fa-fw"></i> 查看、修改所属项目信息</a>
