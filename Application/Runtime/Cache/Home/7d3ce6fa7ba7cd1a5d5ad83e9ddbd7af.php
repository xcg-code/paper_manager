...
<body>
	...
	<section id="page">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<div class="description">修改科研成果</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
										...
										<div class="tabbable header-tabs">
											...
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<form class="form-horizontal" action="/PaperManager/index.php/Home/Achievement/patent_edit_db/achi_id/<?php echo ($PatentInfo["id"]); ?>" method="post">
														<div class="row">
															<div class="col-md-12">
																<div class="box-body">
																	<div class="form-group">
																		...
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="country" value="中国专利" id="chinese" <?php if($PatentInfo["country"] == 中国专利): ?>checked<?php endif; ?>> 中国专利 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="country" value="美国专利" id="usa" <?php if($PatentInfo["country"] == 美国专利): ?>checked<?php endif; ?>> 美国专利 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="country" value="欧洲专利" id="europe" <?php if($PatentInfo["country"] == 欧洲专利): ?>checked<?php endif; ?>> 欧洲专利 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="country" value="WIPO专利" id="wipo" <?php if($PatentInfo["country"] == WIPO专利): ?>checked<?php endif; ?>> WIPO专利 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="country" value="日本专利" id="japan" <?php if($PatentInfo["country"] == 日本专利): ?>checked<?php endif; ?>> 日本专利 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="country" value="其他国家专利" id="other_country" <?php if($PatentInfo["country"] == 其他国家专利): ?>checked<?php endif; ?>> 其他国家专利 </label> 
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">专利名称(中文)</label> 
																		<div class="col-md-8"><input type="text" name="title_zh" class="form-control" value="<?php echo ($PatentInfo["title_zh"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">专利名称(英文)</label> 
																		<div class="col-md-8"><input type="text" name="title_en" class="form-control" value="<?php echo ($PatentInfo["title_en"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">申请(专利)号</label> 
																		<div class="col-md-8"><input type="text" name="patent_num" class="form-control" value="<?php echo ($PatentInfo["patent_num"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">摘要</label> 
																		<div class="col-md-8"><textarea name="abstract" class="form-control"><?php echo ($PatentInfo["abstract"]); ?></textarea></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">关键词(用分号间隔)</label> 
																		<div class="col-md-8"><input type="text" name="keywords" class="form-control" value="<?php echo ($PatentInfo["keywords"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">专利权人</label> 
																		<div class="col-md-8"><input type="text" name="owner" class="form-control" value="<?php echo ($PatentInfo["owner"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">主(IPC)号</label> 
																		<div class="col-md-3"><input type="text" name="ipc" class="form-control" value="<?php echo ($PatentInfo["ipc"]); ?>"></div>
																		<label class="col-md-1 control-label">CPC号</label> 
																		<div class="col-md-4"><input type="text" name="cpc" class="form-control" value="<?php echo ($PatentInfo["cpc"]); ?>"></div>
																	</div>
																	
																	<div class="form-group">
																		<label class="col-md-2 control-label">申请人</label> 
																		<div class="col-md-3"><input type="text" name="applyer" class="form-control" value="<?php echo ($PatentInfo["applyer"]); ?>"></div>
																		<label class="col-md-1 control-label">发证单位</label> 
																		<div class="col-md-4"><input type="text" name="publisher" class="form-control" value="<?php echo ($PatentInfo["publisher"]); ?>"></div>
																	</div>
																	<div class="form-group" id="patent_type">
																		<label class="col-md-2 control-label">专利类别</label> 
																		<?php if(($PatentInfo["country"]) == "中国专利"): ?><div class="col-md-8">
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="发明专利" <?php if($PatentInfo["patent_type"] == 发明专利): ?>checked<?php endif; ?>> 发明专利 </label> 
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="实用专利" <?php if($PatentInfo["patent_type"] == 实用专利): ?>checked<?php endif; ?>> 实用专利 </label> 
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="外观设计" <?php if($PatentInfo["patent_type"] == 外观设计): ?>checked<?php endif; ?>> 外观设计 </label> 
																			</div><?php endif; ?>
																		<?php if(($PatentInfo["country"]) == "美国专利"): ?><div class="col-md-8">
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="发明专利" <?php if($PatentInfo["patent_type"] == 发明专利): ?>checked<?php endif; ?>> 发明专利 </label> 
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="外观设计" <?php if($PatentInfo["patent_type"] == 外观设计): ?>checked<?php endif; ?>> 外观设计 </label> 
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="植物专利" <?php if($PatentInfo["patent_type"] == 植物专利): ?>checked<?php endif; ?>> 植物专利 </label> 
																			</div><?php endif; ?>
																		<?php if(($PatentInfo["country"]) == "欧洲专利"): ?><div class="col-md-8">
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="发明专利" <?php if($PatentInfo["patent_type"] == 发明专利): ?>checked<?php endif; ?>> 发明专利 </label> 
																			</div><?php endif; ?>
																		<?php if(($PatentInfo["country"]) == "WIPO专利"): ?><div class="col-md-8">
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="发明专利" <?php if($PatentInfo["patent_type"] == 发明专利): ?>checked<?php endif; ?>> 发明专利 </label> 
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="实用新型" <?php if($PatentInfo["patent_type"] == 实用新型): ?>checked<?php endif; ?>> 实用新型 </label> 
																			</div><?php endif; ?>
																		<?php if(($PatentInfo["country"]) == "日本专利"): ?><div class="col-md-8">
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="发明专利" <?php if($PatentInfo["patent_type"] == 发明专利): ?>checked<?php endif; ?>> 发明专利 </label> 
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="实用专利" <?php if($PatentInfo["patent_type"] == 实用专利): ?>checked<?php endif; ?>> 实用专利 </label> 
																				<label class="radio-inline"> <input type="radio" name="patent_type" value="外观设计" <?php if($PatentInfo["patent_type"] == 外观设计): ?>checked<?php endif; ?>> 外观设计 </label> 
																			</div><?php endif; ?>
																		<?php if(($PatentInfo["country"]) == "其他专利"): ?><label class="col-md-2 control-label">专利类别</label> 
																			<div class="col-md-4"><input type="text" name="patent_type" class="form-control" value="<?php echo ($PatentInfo["patent_type"]); ?>"></div><?php endif; ?>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">专利状态</label> 
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="status" value="申请" id="apply" <?php if($PatentInfo["status"] == 申请): ?>checked<?php endif; ?>> 申请 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="status" value="授权" id="auth" <?php if($PatentInfo["status"] == 授权): ?>checked<?php endif; ?>> 授权 </label> 
																		</div>
																	</div>
																	<div id="PatentInfo">
																		<?php if(($PatentInfo["status"]) == "申请"): ?><div class="form-group" >
																				<label class="col-md-2 control-label">申请日期</label> 
																				<div class="col-md-2"><input type="date" name="apply_date" class="form-control" value="<?php echo ($PatentInfo["apply_date"]); ?>"></div>
																			</div><?php endif; ?>
																		<?php if(($PatentInfo["status"]) == "授权"): ?><div class="form-group" >
																			...
																			<div class="form-group">
																				...
																				<div class="col-md-4">
																					<label class="radio-inline"> <input type="radio" name="tran_status" value="转让" <?php if($PatentInfo["tran_status"] == 转让): ?>checked<?php endif; ?>> 转让 </label> 
																					<label class="radio-inline"> <input type="radio" name="tran_status" value="许可" <?php if($PatentInfo["tran_status"] == 许可): ?>checked<?php endif; ?>> 许可 </label> 
																					<label class="radio-inline"> <input type="radio" name="tran_status" value="作价投资" <?php if($PatentInfo["tran_status"] == 作价投资): ?>checked<?php endif; ?>> 作价投资 </label> 
																					<label class="radio-inline"> <input type="radio" name="tran_status" value="其他" <?php if($PatentInfo["tran_status"] == 其他): ?>checked<?php endif; ?>> 其他 </label> 
																					<label class="radio-inline"> <input type="radio" name="tran_status" value="无" <?php if($PatentInfo["tran_status"] == 无): ?>checked<?php endif; ?>> 无 </label> 
																				</div>
																				<label class="col-md-2 control-label">交易金额(万元)</label> 
																				<div class="col-md-2"><input type="text" name="price" class="form-control" value="<?php echo ($PatentInfo["price"]); ?>"></div>
																			</div><?php endif; ?>
																	</div>
																	<div class="form-group">
		...
		<div class="form-group" id="other_info" hidden="true">
			<label class="col-md-2 control-label">专利类别</label> 
			<div class="col-md-4"><input type="text" name="patent_type" class="form-control" value="<?php echo ($PatentInfo["patent_type"]); ?>"></div>
		</div>
