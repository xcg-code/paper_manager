										...
										<div class="tabbable header-tabs">
											...
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<form class="form-horizontal" action="/PaperManager/index.php/Home/Project/git" method="post">
														<div class="row">
															<div class="col-md-12">
																<div class="box-body">
																	<div id="info">
																		<div class="form-group">
																			...
																			<div class="col-md-4"><input type="text" name="name" class="form-control" value=""></div>
																			<label class="col-md-1 control-label">申请经费</label> 
