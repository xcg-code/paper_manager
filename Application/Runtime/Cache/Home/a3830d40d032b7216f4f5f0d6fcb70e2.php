	...
	<script>
		jQuery(document).ready(function() {		
			...
			$("#AddAuthor").click(function(){
    			$("#AuthorInfo").append("<div class=\"form-group\"><label class=\"col-md-2 control-label\">文章中的作者姓名</label> <div class=\"col-md-2\"><input type=\"text\" name=\"juan_num\" class=\"form-control\" value=\"\"></div><label class=\"col-md-1 control-label\">作者单位</label> <div class=\"col-md-2\"><input type=\"text\" name=\"qi_num\" class=\"form-control\" value=\"\"></div><label class=\"col-md-1 control-label\">电子邮箱</label> <div class=\"col-md-2\"><input type=\"text\" name=\"qi_num\" class=\"form-control\" value=\"\"></div></div>     <div class=\"form-group\"><label class=\"col-md-2 control-label\">作者属性</label><div class=\"col-md-2\"><label class=\"checkbox-inline\"> <input type=\"checkbox\" class=\"uniform\" name=\"not_have_page\" value=\"no\">是否通讯作者 </label> </div><div class=\"col-md-2\"><label class=\"checkbox-inline\"> <input type=\"checkbox\" class=\"uniform\" name=\"not_have_page\" value=\"no\">是否第一作者 </label> </div><div class=\"col-md-2\"><label class=\"checkbox-inline\"> <input type=\"checkbox\" class=\"uniform\" name=\"not_have_page\" value=\"no\">是否主要参与者 </label> </div><div class=\"col-md-2\"><label class=\"checkbox-inline\"> <input type=\"checkbox\" class=\"uniform\" name=\"not_have_page\" value=\"no\">是否项目承担单位 </label> </div></div> <hr style=\"height:3px;border:none;border-top:3px double red;\" />");
  			});
		});
	</script>
	<!-- /JAVASCRIPTS -->
