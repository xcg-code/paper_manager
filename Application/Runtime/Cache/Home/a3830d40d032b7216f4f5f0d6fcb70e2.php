						...
						<ul>
							...
							<li class="has-sub">
								...
								<ul class="sub">
									...
									<li><a class="" href="#"><span class="sub-menu-text">我的科研成果</span></a></li>
								</ul>
							</li>
						</ul>
						<!-- /SIDEBAR MENU -->
										...
										<div class="tabbable header-tabs">
										  ...
										  <div class="tab-content">
											 <div class="tab-pane fade in active" id="box_tab1">
												<form class="form-horizontal" action="/PaperManager/index.php/Home/Achievement/add/id/<?php echo ($Profile["id"]); ?>" method="post">
														<div class="row">
															<div class="col-md-12">
																	<div class="box-body">
