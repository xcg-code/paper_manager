		...
		<div id="info" hidden="true">
		  ...
		  <label class="col-md-2 control-label">文章中的作者姓名</label> 
		   ...
		   <div class="form-group">
		   		...
		   		<div class="col-md-2"><label class="checkbox-inline"> <input type="checkbox" class="uniform" name="is_contact_" value="no">是否通讯作者 </label></div>
		   		<div class="col-md-2"><label class="checkbox-inline"> <input type="checkbox" class="uniform" name="is_first_" value="no">是否第一作者 </label></div>
		   		<div class="col-md-2"><label class="checkbox-inline"> <input type="checkbox" class="uniform" name="is_main_" value="no">是否主要参与者 </label></div>
		   		<div class="col-md-2"><label class="checkbox-inline"> <input type="checkbox" class="uniform" name="is_company_" value="no">是否项目承担单位 </label></div>
		   </div>
