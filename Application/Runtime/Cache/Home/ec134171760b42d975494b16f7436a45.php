					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left"><?php echo ($RewardInfo["title_zh"]); ?></h3>
									</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i><?php echo ($RewardInfo["title_zh"]); ?></h4>
														...
														<table class="table table-striped">
															<tbody>
																<tr>
																	...
																	<td><?php echo ($RewardInfo["achievement_type"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">成果名称(中文)</td>
																	<td><?php echo ($RewardInfo["title_zh"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">成果名称(英文)</td>
																	<td><?php echo ($RewardInfo["title_en"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">摘要</td>
																	<td><?php echo ($RewardInfo["abstract"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">关键词</td>
																	<td><?php echo ($RewardInfo["keywords"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">奖励种类</td>
																	<td><?php echo ($RewardInfo["reward_type"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">注明</td>
																	<td><?php echo ($RewardInfo["specific"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">奖励等级</td>
																	<td><?php echo ($RewardInfo["reward_level"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">授奖机构</td>
																	<td><?php echo ($RewardInfo["institute"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">授奖日期</td>
																	<td><?php echo ($RewardInfo["publish_date"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">证书编号</td>
																	<td><?php echo ($RewardInfo["reward_num"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">与项目关系</td>
																	<td><?php echo ($RewardInfo["relationship"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">备注</td>
																	<td><?php echo ($RewardInfo["content"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">全文链接</td>
																	<td><?php echo ($RewardInfo["paper_link"]); ?></td>
																</tr>
															</tbody>
														</table>
													</div>
