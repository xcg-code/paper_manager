												...
												<div class="tab-pane fade in active" id="box_tab1">
													<div class="row">
														<div class="col-md-12">
															...
															<div class="box-body">
																<div class="alert alert-info"><strong>在上传项目文件前，请确信您已经从版权所有人得到使用该文件的授权，文件大小不能超过20MB。(允许上传的文件格式包括：*.pdf,*.doc,*docx,*.ppt,*pptx,*xls,*xlsx)</strong></div>
																<form class="form-horizontal" action="/PaperManager/index.php/Home/Project/git_file_upload/git_id/<?php echo ($git_id); ?>" method="post" enctype="multipart/form-data">
																	...
																	<div class="form-actions clearfix"> <input type="submit" value="上传文件" class="btn btn-primary pull-right"></div>
