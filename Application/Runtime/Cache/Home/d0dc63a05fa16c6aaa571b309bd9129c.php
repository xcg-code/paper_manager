															...
															<div class="col-md-12">
																<div class="box-body">
																	<div class="form-group">
																		...
																		<div class="col-md-8"><input type="text" name="title_zh" class="form-control" value="<?php echo ($MonographInfo["title_zh"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">专著题目(英文)</label> 
																		<div class="col-md-8"><input type="text" name="title_en" class="form-control" value="<?php echo ($MonographInfo["title_en"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">书名</label> 
																		<div class="col-md-8"><input type="text" name="book_name" class="form-control" value="<?php echo ($MonographInfo["book_name"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">丛书名称</label> 
																		<div class="col-md-8"><input type="text" name="books_name" class="form-control" value="<?php echo ($MonographInfo["books_name"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">语言</label> 
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="language" value="中文" <?php if($MonographInfo["language"] == 中文): ?>checked<?php endif; ?>> 中文 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="language" value="英文" <?php if($MonographInfo["language"] == 英文): ?>checked<?php endif; ?>> 英文 </label>
																		</div>
																	</div>
																	<div class="form-group">
																	<label class="col-md-2 control-label">状态</label> 
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="status" value="已出版" <?php if($MonographInfo["status"] == 已出版): ?>checked<?php endif; ?>> 已出版 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="status" value="待出版" <?php if($MonographInfo["status"] == 待出版): ?>checked<?php endif; ?>> 待出版 </label>
																			
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">ISBN号</label> 
																		<div class="col-md-3"><input type="text" name="isbn" class="form-control" value="<?php echo ($MonographInfo["isbn"]); ?>"></div>
																		<label class="col-md-1 control-label">编辑</label> 
																		<div class="col-md-4"><input type="text" name="editor" class="form-control" value="<?php echo ($MonographInfo["editor"]); ?>"></div>
																	</div>
																	
																	<div class="form-group">
																		<label class="col-md-2 control-label">国家或地区</label> 
																		<div class="col-md-3"><input type="text" name="country" class="form-control" value="<?php echo ($MonographInfo["country"]); ?>"></div>
																		<label class="col-md-1 control-label">城市</label> 
																		<div class="col-md-4"><input type="text" name="city" class="form-control" value="<?php echo ($MonographInfo["city"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">起始页码</label>
																		<div class="col-md-1"><input type="text" name="start_page" class="form-control" value="<?php echo ($MonographInfo["start_page"]); ?>"></div>
																		<label class="col-md-1 control-label">————</label> 
																		<div class="col-md-1"><input type="text" name="end_page" class="form-control" value="<?php echo ($MonographInfo["end_page"]); ?>"></div>
																		<label class="col-md-1 control-label">总字数</label> 
																		<div class="col-md-4"><input type="text" name="words_num" class="form-control" value="<?php echo ($MonographInfo["words_num"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">出版社</label> 
																		<div class="col-md-2"><input type="text" name="publisher" class="form-control" value="<?php echo ($MonographInfo["publisher"]); ?>"></div>
																		<label class="col-md-2 control-label">出版时间(按版权页填写)</label> 
																		<div class="col-md-2"><input type="date" name="publish_date" class="form-control" value="<?php echo ($MonographInfo["publish_date"]); ?>"></div>
																		
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">与项目的关系</label> 
																		<div class="col-md-2"><input type="text" name="relationship" class="form-control" value="<?php echo ($MonographInfo["relationship"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">备注</label> 
																		<div class="col-md-8"><textarea name="content" class="form-control"><?php echo ($MonographInfo["content"]); ?></textarea></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">全文链接</label> 
																		<div class="col-md-8"><input type="text" name="paper_link" class="form-control" value="<?php echo ($MonographInfo["paper_link"]); ?>"></div>
																	</div>
																</div>
															</div>
														</div>
