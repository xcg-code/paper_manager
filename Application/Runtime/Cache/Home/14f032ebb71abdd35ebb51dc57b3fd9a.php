															...
															<div class="col-md-12">
																<div class="box-body">
																	...
																	<label class="col-md-2 control-label">报告类型</label> 
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="type" value="特邀报告"> 特邀报告 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="type" value="分组报告"> 分组报告 </label>
																			<label class="radio-inline"> <input type="radio" class="uniform" name="type" value="墙报展示"> 墙报展示 </label>
																		</div>
																	</div>
																	<div class="form-group">
																	<label class="col-md-2 control-label">会议类型</label> 
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="type" value="国际学术会议"> 国际学术会议 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="type" value="国内学术会议"> 国内学术会议 </label>
																		</div>
																	</div>
																	<div class="form-group">
