					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left"><?php echo ($StandardInfo["title_zh"]); ?></h3>
									</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i><?php echo ($StandardInfo["title_zh"]); ?></h4>
														...
														<table class="table table-striped">
															<tbody>
																<tr>
																	...
																	<td><?php echo ($StandardInfo["achievement_type"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">标准类型</td>
																	<td><?php echo ($StandardInfo["country"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">标题(中文)</td>
																	<td><?php echo ($StandardInfo["title_zh"]); ?></td>
																</tr>
																<tr>
																...
																<tr>
																	<td style="width: 15%;text-align:center">标准类型</td>
																	<td><?php echo ($StandardInfo["standard_type"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">标准公布机构</td>
																	<td><?php echo ($StandardInfo["institute"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">发布时间</td>
																	<td><?php echo ($StandardInfo["publish_date"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">备注</td>
																	<td><?php echo ($StandardInfo["content"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">全文链接</td>
																	<td><?php echo ($StandardInfo["paper_link"]); ?></td>
																</tr>
															</tbody>
														</table>
													</div>
