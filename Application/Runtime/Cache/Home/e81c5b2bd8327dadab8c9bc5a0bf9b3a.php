										...
										<div class="tabbable header-tabs">
											...
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<form class="form-horizontal" action="/PaperManager/index.php/Home/Achievement/conference_report_edit_db/achi_id/<?php echo ($ReportInfo["id"]); ?>" method="post">
														<div class="row">
															<div class="col-md-12">
																<div class="box-body">
																	...
																	<label class="col-md-2 control-label">报告类型</label> 
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="report_type" value="特邀报告" <?php if($ReportInfo["report_type"] == 特邀报告): ?>checked<?php endif; ?>> 特邀报告 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="report_type" value="分组报告" <?php if($ReportInfo["report_type"] == 分组报告): ?>checked<?php endif; ?>> 分组报告 </label>
																			<label class="radio-inline"> <input type="radio" class="uniform" name="report_type" value="墙报展示" <?php if($ReportInfo["report_type"] == 墙报展示): ?>checked<?php endif; ?>> 墙报展示 </label>
																		</div>
																	</div>
																	<div class="form-group">
																	<label class="col-md-2 control-label">会议类型</label> 
																		<div class="col-md-8">
																			<label class="radio-inline"> <input type="radio" class="uniform" name="conference_type" value="国际学术会议" <?php if($ReportInfo["conference_type"] == 国际学术会议): ?>checked<?php endif; ?>> 国际学术会议 </label> 
																			<label class="radio-inline"> <input type="radio" class="uniform" name="conference_type" value="国内学术会议" <?php if($ReportInfo["conference_type"] == 国内学术会议): ?>checked<?php endif; ?>> 国内学术会议 </label>
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">报告名称(中文)</label> 
																		<div class="col-md-8"><input type="text" name="title_zh" class="form-control" value="<?php echo ($ReportInfo["title_zh"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">报告名称(英文)</label> 
																		<div class="col-md-8"><input type="text" name="title_en" class="form-control" value="<?php echo ($ReportInfo["title_en"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">报告摘要</label> 
																		<div class="col-md-8"><textarea name="abstract" class="form-control"><?php echo ($ReportInfo["abstract"]); ?></textarea></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">关键词(用分号隔开)</label> 
																		<div class="col-md-8"><input type="text" name="keywords" class="form-control" value="<?php echo ($ReportInfo["keywords"]); ?>"></div>
																	</div>
																	
																	<div class="form-group">
																		<label class="col-md-2 control-label">会议名称(中文)</label> 
																		<div class="col-md-3"><input type="text" name="conference_zh" class="form-control" value="<?php echo ($ReportInfo["conference_zh"]); ?>"></div>
																		<label class="col-md-1 control-label">会议名称(英文)</label> 
																		<div class="col-md-4"><input type="text" name="conference_en" class="form-control" value="<?php echo ($ReportInfo["conference_en"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">会议地址</label> 
																		<div class="col-md-8"><input type="text" name="address" class="form-control" value="<?php echo ($ReportInfo["address"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">国家或地区</label> 
																		<div class="col-md-3"><input type="text" name="country" class="form-control" value="<?php echo ($ReportInfo["country"]); ?>"></div>
																		<label class="col-md-1 control-label">城市</label> 
																		<div class="col-md-4"><input type="text" name="city" class="form-control" value="<?php echo ($ReportInfo["city"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">会议开始日期</label> 
																		<div class="col-md-2"><input type="date" name="start_date" class="form-control" value="<?php echo ($ReportInfo["start_date"]); ?>"></div>
																		<label class="col-md-2 control-label">会议结束日期</label> 
																		<div class="col-md-2"><input type="date" name="end_date" class="form-control" value="<?php echo ($ReportInfo["end_date"]); ?>"></div>
																		
																	</div>									
																	<div class="form-group">
																		<label class="col-md-2 control-label">备注</label> 
																		<div class="col-md-8"><textarea name="content" class="form-control"><?php echo ($ReportInfo["content"]); ?></textarea></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">全文链接</label> 
																		<div class="col-md-8"><input type="text" name="paper_link" class="form-control" value="<?php echo ($ReportInfo["paper_link"]); ?>"></div>
																	</div>
																</div>
															</div>
														</div>
