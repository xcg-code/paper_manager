						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border">
									<div class="box-title">
										<h4><i class="fa fa-user"></i><span class="hidden-inline-mobile"><?php echo ($Profile["fullname"]); ?></span></h4>
									</div>
									<div class="box-body">
															...
															<div class="col-md-12 profile-details">		
																...
																<div class="row">
																	<div class="col-md-4 text-center">
																		<div id="pie_1" class="piechart" data-percent="<?php echo ($AchiPercent["JournalPaper"]); ?>">
																			<span class="percent"></span>
																		</div>
																		<div class="skill-name"><h4>期刊论文</h4></div>
																	</div>
																	<div class="col-md-4 text-center">
																		<div id="pie_2" class="piechart" data-percent="<?php echo ($AchiPercent["ConferencePaper"]); ?>">
																			<span class="percent"></span>
																		</div>
																		<div class="skill-name"><h4>会议论文</h4></div>
																	</div>
																	<div class="col-md-4 text-center">
																		<div id="pie_3" class="piechart" data-percent="<?php echo ($AchiPercent["Remain"]); ?>">
																			<span class="percent"></span>
																		</div>
																		<div class="skill-name"><h4>其他</h4></div>
																	</div>
																</div>
																<div class="divide-20"></div>
																<!-- BUTTONS -->
																<div class="row">
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>期刊论文</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["JournalPaper"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>会议论文</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["ConferencePaper"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>学术著作</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["Monograph"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>会议报告</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["ConferenceReport"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>专利</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["Patent"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>标准</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["Standard"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>软件著作权</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["Software"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>科研奖励</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["Reward"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>人才培养</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["Train"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>举办或参加学术会议</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["ConferenceInvolved"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>成果技术转移</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["TechTrans"]); ?></span>
																		</a>
																	</div>
																	<div class="col-md-3">
																		<a class="btn btn-info btn-icon input-block-level" href="javascript:void(0);">
																			<div>其他重要研究成果</div>
																			<span class="label label-right label-danger"><?php echo ($AchievementCount["OtherAchievement"]); ?></span>
																		</a>
																	</div>
