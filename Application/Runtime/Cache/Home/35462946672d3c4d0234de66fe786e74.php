					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<div class="description">查看，检索实验室人员信息</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-12">
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i><?php echo ($UserInfo["lab_name"]); ?></h4>
									...
									<div class="box-body">
										<div class="row">
											...
											<div class="col-md-9">
												<form action="/PaperManager/index.php/Home/Lab/my_project/<?php echo ($SearchAction); ?>" method="post">
