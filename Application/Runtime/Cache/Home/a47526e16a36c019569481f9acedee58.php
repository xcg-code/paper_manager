						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border">
									<div class="box-title">
										<h4><i class="fa fa-user"></i><span class="hidden-inline-mobile">科研奖励</span></h4>
									</div>
									<div class="box-body">
										<div class="tabbable header-tabs">
											...
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<form class="form-horizontal" action="/PaperManager/index.php/Home/Achievement/reward_edit_db/achi_id/<?php echo ($RewardInfo["id"]); ?>" method="post">
														<div class="row">
															<div class="col-md-12">
																<div class="box-body">
																	<div class="form-group">
																		<label class="col-md-2 control-label">成果名称(中文)</label> 
																		<div class="col-md-8"><input type="text" name="title_zh" class="form-control" value="<?php echo ($RewardInfo["title_zh"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">成果名称(英文)</label> 
																		<div class="col-md-8"><input type="text" name="title_en" class="form-control" value="<?php echo ($RewardInfo["title_en"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">摘要</label> 
																		<div class="col-md-8"><textarea name="abstract" class="form-control"><?php echo ($RewardInfo["abstract"]); ?></textarea></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">关键词(用分号间隔)</label> 
																		<div class="col-md-8"><input type="text" name="keywords" class="form-control" value="<?php echo ($RewardInfo["keywords"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">奖励种类</label> 
																		<div class="col-md-8"><select class="form-control" name="reward_type" id="reward_type">
																			<option></option>
																			<option <?php if($RewardInfo["reward_type"] == 自然科学): ?>selected="selected"<?php endif; ?>>自然科学</option>
																			<option <?php if($RewardInfo["reward_type"] == 科技进步): ?>selected="selected"<?php endif; ?>>科技进步</option>
																			<option <?php if($RewardInfo["reward_type"] == 发明): ?>selected="selected"<?php endif; ?>>发明</option>
																			<option <?php if($RewardInfo["reward_type"] == 其他): ?>selected="selected"<?php endif; ?>>其他</option>
																		</select></div>
																	</div>	
																	<?php if(($RewardInfo["reward_type"]) == "其他"): ?><div class="form-group" id="specific">
																		<label class="col-md-2 control-label">请注明</label> 
																		<div class="col-md-8"><input type="text" name="specific" class="form-control" value="<?php echo ($RewardInfo["specific"]); ?>"></div>
																		</div><?php endif; ?>					
																	
																	<div class="form-group">
																		<label class="col-md-2 control-label">奖励等级</label> 
																		<div class="col-md-8"><select class="form-control" name="reward_level">
																			<option></option>
																			<option <?php if($RewardInfo["reward_level"] == 国际学术奖): ?>selected="selected"<?php endif; ?>>国际学术奖</option>
																			<option <?php if($RewardInfo["reward_level"] == 国家一等奖): ?>selected="selected"<?php endif; ?>>国家一等奖</option>
																			<option <?php if($RewardInfo["reward_level"] == 国家二等奖): ?>selected="selected"<?php endif; ?>>国家二等奖</option>
																			<option <?php if($RewardInfo["reward_level"] == 省部一等奖): ?>selected="selected"<?php endif; ?>>省部一等奖</option>
																			<option <?php if($RewardInfo["reward_level"] == 省部二等奖): ?>selected="selected"<?php endif; ?>>省部二等奖</option>
																			<option <?php if($RewardInfo["reward_level"] == 其他): ?>selected="selected"<?php endif; ?>>其他</option>
																		</select></div>
																	</div>	
																	<div class="form-group">
																		<label class="col-md-2 control-label">授奖机构</label> 
																		<div class="col-md-8"><input type="text" name="institute" class="form-control" value="<?php echo ($RewardInfo["institute"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">授奖日期</label> 
																		<div class="col-md-2"><input type="date" name="publish_date" class="form-control" value="<?php echo ($RewardInfo["publish_date"]); ?>"></div>
																		
																	</div>	
																	<div class="form-group">
																		<label class="col-md-2 control-label">证书编号</label> 
																		<div class="col-md-8"><input type="text" name="reward_num" class="form-control" value="<?php echo ($RewardInfo["reward_num"]); ?>"></div>
																	</div>	
																	<div class="form-group">
																		<label class="col-md-2 control-label">与项目关系</label> 
																		<div class="col-md-8"><input type="text" name="relationship" class="form-control" value="<?php echo ($RewardInfo["relationship"]); ?>"></div>
																	</div>								
																	<div class="form-group">
																		<label class="col-md-2 control-label">备注</label> 
																		<div class="col-md-8"><textarea name="content" class="form-control"><?php echo ($RewardInfo["content"]); ?></textarea></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">全文链接</label> 
																		<div class="col-md-8"><input type="text" name="paper_link" class="form-control" value="<?php echo ($RewardInfo["paper_link"]); ?>"></div>
																	</div>
																</div>
															</div>
														</div>
	...
	<script>
		...
		jQuery(document).ready(function() {		
			...
			$("#reward_type").change(function(){
				var checkText=$("#reward_type").find("option:selected").text();
				if(checkText=='其他'){
					$("#specific").show();
				}else{
					$("#specific").hide();
