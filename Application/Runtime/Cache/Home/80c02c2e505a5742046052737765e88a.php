						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">修改科研成果信息</h3>
									</div>
									<div class="description">修改期刊论文基本信息</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
															...
															<div class="col-md-12">
																<div class="box-body">
																	<div class="form-group">
																		...
																		<div class="col-md-8"><input type="text" name="title_zh" class="form-control" value="<?php echo ($JournalInfo["title_zh"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">标题(英文)</label> 
																		<div class="col-md-8"><input type="text" name="title_en" class="form-control" value="<?php echo ($JournalInfo["title_en"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">摘要</label> 
																		<div class="col-md-8"><textarea name="abstract" class="form-control"><?php echo ($JournalInfo["abstract"]); ?></textarea></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">关键词(用分号隔开)</label> 
																		<div class="col-md-8"><input type="text" name="keywords" class="form-control" value="<?php echo ($JournalInfo["keywords"]); ?>"></div>
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-8"><input type="text" name="journal_name" class="form-control" value="<?php echo ($JournalInfo["journal_name"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">发表日期</label> 
																		<div class="col-md-8"><input type="date" name="publish_date" class="form-control" value="<?php echo ($JournalInfo["publish_date"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">DOI</label> 
																		<div class="col-md-8"><input type="text" name="doi" class="form-control" value="<?php echo ($JournalInfo["doi"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">文章号</label> 
																		<div class="col-md-8"><input type="text" name="paper_num" class="form-control" value="<?php echo ($JournalInfo["paper_num"]); ?>"></div>
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-8"><input type="text" name="refer_num" class="form-control" value="<?php echo ($JournalInfo["refer_num"]); ?>"></div>
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-3"><input type="text" name="juan_num" class="form-control" value="<?php echo ($JournalInfo["juan_num"]); ?>"></div>
																		<label class="col-md-1 control-label">期号</label> 
																		<div class="col-md-3"><input type="text" name="qi_num" class="form-control" value="<?php echo ($JournalInfo["qi_num"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		...
																		<div class="col-md-1"><input type="text" name="end_page" class="form-control" value="<?php echo ($JournalInfo["end_page"]); ?>"></div>
																	</div>
																	<div class="form-group">
																		<label class="col-md-2 control-label">全文链接</label> 
																		<div class="col-md-8"><input type="text" name="paper_link" class="form-control" value="<?php echo ($JournalInfo["paper_link"]); ?>"></div>
																	</div>
																</div>
															</div>
														</div>
