					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">我收藏的科研成果</h3>
									</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>我收藏的科研成果</h4>
										...
										<div class="row">
											<div class="col-md-3">
												<div class="list-group">
													...
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["All"]); ?></span><i class="fa fa-user fa-fw"></i> 所有成果</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/JournalPaper/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["JournalPaper"]); ?></span><i class="fa fa-calendar fa-fw"></i> 期刊论文
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/ConferencePaper/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["ConferencePaper"]); ?></span><i class="fa fa-calendar fa-fw"></i> 会议论文
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/Monograph/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["Monograph"]); ?></span><i class="fa fa-calendar fa-fw"></i> 学术专著
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/Patent/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["Patent"]); ?></span><i class="fa fa-calendar fa-fw"></i> 专利
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/ConferenceReport/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["ConferenceReport"]); ?></span><i class="fa fa-calendar fa-fw"></i> 会议报告
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/Standard/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["Standard"]); ?></span><i class="fa fa-calendar fa-fw"></i> 标准
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/Software/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["Software"]); ?></span><i class="fa fa-calendar fa-fw"></i> 软件著作权
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/Reward/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["Reward"]); ?></span><i class="fa fa-calendar fa-fw"></i> 科研奖励
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/Train/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["Train"]); ?></span><i class="fa fa-calendar fa-fw"></i> 人才培养
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/ConferenceInvolved/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["ConferenceInvolved"]); ?></span><i class="fa fa-calendar fa-fw"></i> 举办或参加学术会议
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/TechTrans/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["TechTrans"]); ?></span><i class="fa fa-calendar fa-fw"></i> 成果技术转移
													</a>
													<a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_type/OtherAchievement/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($AchievementCount["OtherAchievement"]); ?></span><i class="fa fa-calendar fa-fw"></i> 其他重要研究成果
													</a>

													<div class="list-group-item profile-details">
														<h4>发表年份</h4>
													</div>
													<?php if(is_array($AchievementYear)): $i = 0; $__LIST__ = $AchievementYear;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/PaperManager/index.php/Home/Favorite/my_achievement/achi_year/<?php echo ($vo["year"]); ?>/user_id/<?php echo ($user_id); ?>" class="list-group-item"><span class="badge badge-red"><?php echo ($vo["num"]); ?></span><i class="fa fa-calendar fa-fw"></i> <?php echo ($vo["year"]); ?>
														</a><?php endforeach; endif; else: echo "" ;endif; ?>
												</div>														
											</div>
											<div class="col-md-9">
												<form action="/PaperManager/index.php/Home/Favorite/my_achievement<?php echo ($SearchAction); ?>/user_id/<?php echo ($user_id); ?>" method="post">
												...
												<?php if(is_array($FavInfo)): $i = 0; $__LIST__ = $FavInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="search-results">
