					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="login-box-plain">
								...
								<form role="form" method="post" action="/PaperManager/index.php/Home/Index/login">
					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="login-box-plain">
								...
								<div class="divide-40"></div>
								<form role="form" method="post" action="/PaperManager/index.php/Home/Index/register">
								  <div class="form-group">
								  ...
								  <div class="form-actions">
									<label class="checkbox"> <input type="checkbox" class="uniform" value="" checked="checked">我同意<a href="#">团队服务</a> 与 <a href="#">隐私条款</a></label>
