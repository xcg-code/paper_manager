																		...
																		<table class="table table-striped">
																			...
																			<tbody>
																				<?php if(is_array($BugInfo)): $i = 0; $__LIST__ = $BugInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
																					...
																					<td><button type="button" class="btn btn-xs btn-success" onclick="window.location.href='/PaperManager/index.php/Home/Project/git_my_bug_show/bug_id/<?php echo ($vo["id"]); ?>/git_id/<?php echo ($git_id); ?>'">处理</button></td>
