					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left"><?php echo ($PatentInfo["title_zh"]); ?></h3>
									</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i><?php echo ($PatentInfo["title_zh"]); ?></h4>
														...
														<table class="table table-striped">
															<tbody>
																<tr>
																	...
																	<td><?php echo ($PatentInfo["achievement_type"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">专利名称(中文)</td>
																	<td><?php echo ($PatentInfo["title_zh"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">专利名称(英文)</td>
																	<td><?php echo ($PatentInfo["title_en"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">专利国家</td>
																	<td><?php echo ($PatentInfo["country"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">申请(专利)号</td>
																	<td><?php echo ($PatentInfo["patent_num"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">摘要</td>
																	<td><?php echo ($PatentInfo["abstract"]); ?></td>
																</tr>
																<tr>
																<td style="width: 15%;text-align:center">关键词</td>
																	<td><?php echo ($PatentInfo["keywords"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">专利权人</td>
																	<td><?php echo ($PatentInfo["owner"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">主(IPC)号</td>
																	<td><?php echo ($PatentInfo["ipc"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">CPC号</td>
																	<td><?php echo ($PatentInfo["cpc"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">申请人</td>
																	<td><?php echo ($PatentInfo["applyer"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">发证单位</td>
																	<td><?php echo ($PatentInfo["publisher"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">专利类别</td>
																	<td><?php echo ($PatentInfo["patent_type"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">专利状态</td>
																	<td><?php echo ($PatentInfo["status"]); ?></td>
																</tr>
																
																<tr>
																	<td style="width: 15%;text-align:center">申请(授权)日期</td>
																	<td><?php echo ($PatentInfo["apply_date"]); ?></td>
																</tr>
																<tr>
																...
																<tr>
																	...
																	<td><?php echo ($PatentInfo["price"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">备注</td>
																	<td><?php echo ($PatentInfo["content"]); ?></td>
																</tr>
																<tr>
																	<td style="width: 15%;text-align:center">全文链接</td>
																	<td><?php echo ($PatentInfo["paper_link"]); ?></td>
																</tr>
															</tbody>
														</table>
													</div>
