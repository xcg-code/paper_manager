										...
										<div class="tabbable header-tabs">
											...
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<form class="form-horizontal" action="/PaperManager/index.php/Home/Achievement/reward_add_db" method="post">
														<div class="row">
															<div class="col-md-12">
																<div class="box-body">
																	...
																	<div class="form-group" hidden="true" id="specific">
																		<label class="col-md-2 control-label">请注明</label> 
																		<div class="col-md-8"><input type="text" name="specific" class="form-control" value=""></div>
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-8"><input type="text" name="reward_num" class="form-control" value=""></div>
																	</div>	
																	<div class="form-group">
																		<label class="col-md-2 control-label">与项目关系</label> 
																		<div class="col-md-8"><input type="text" name="relationship" class="form-control" value=""></div>
																	</div>								
																	<div class="form-group">
