...
//获取科研成果详情链接地址
function get_detail_link($AchievementInfo){
    $detail_link='';
...
function get_page($count, $pagesize = 10){
    ...
    $p->setConfig('header', '<li style="color: #337ab7; margin-left: 15px; font-size: 20px;" >共<b>%TOTAL_ROW%</b>条记录&nbsp;第<b>%NOW_PAGE%</b>页/共<b>%TOTAL_PAGE%</b>页</li>');
    $p->setConfig('last', '末页');
